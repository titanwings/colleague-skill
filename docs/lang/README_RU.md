...
Любимый автор, кумир, мыслитель, с которым ты никогда не встретишься — но хочется знать, что бы он сказал на твой вопрос?<br>

**dot-skill решает все три задачи.**

<br>

Апгрейд от **colleague.skill** до **dot-skill** — теперь не только коллеги, а **кто угодно** может быть дистиллирован в Skill<br>
Коллеги · партнёры · родные · старые друзья · кумиры · публичные фигуры · вымышленные персонажи — даже ты сам<br>
Дай исходные материалы + своё описание → получи **AI Skill, который действительно думает как они**<br>
...
[**中文**](README_ZH.md) · [**English**](../../README.md) · [**Español**](README_ES.md) · [**Deutsch**](README_DE.md) · [**日本語**](README_JA.md) · **Русский** · [**Português**](README_PT.md) · [**한국어**](README_KO.md)
...
### 1. От colleague-skill к dot-skill
...
### 2. Три семейства персонажей

| Семейство | Кому подходит | Примеры |
|-----------|---------------|---------|
| **colleague** | Коллеги, наставники, тиммейты, смежники сверху и снизу | ByteDance L2-1 бэкендер, твой наставник |
| **relationship** | Бывшие, партнёры, родители, друзья, близкие | Сосед по общаге, первая любовь, твоя мама |
| **celebrity** | Публичные фигуры, создатели, публичные голоса, мыслители | 罗翔, Стив Джобс, вымышленные персонажи |

У каждого семейства — собственный пайплайн промптов, стратегия сбора источников и шаблон генерации:

- **`colleague`** — построено на двухслойной архитектуре Work Skill + Persona. Учит и их технические стандарты и воркфлоу, и манеру говорить, и рабочую позицию. Поддерживает автосбор из Feishu / DingTalk / Slack.
- **`celebrity`** — поставляется с полным тулчейном шестимерного исследования (скачивание субтитров → очистка транскрипта → мерж исследований → проверка качества). Не имитация тона — воспроизведение их ментальных моделей и решающих фреймворков.
- **`relationship`** 🆕 **Функция отправки фото скоро появится** — твои дистиллированные отношения не будут просто отвечать на сообщения; они будут присылать фотографии и делиться кусочками своего дня, как это делал бы живой человек.

### 3. Больше Agent-хостов
...
> 🆕 **Обновление 2026.04.19** — **Группа 5 WeChat запущена!** Заходи в сообщество dot-skill — делиться навыками, обсуждать фичи, обмениваться советами.
>
> <img src="../assets/wechat-group-qr-5.png" alt="QR-код группы WeChat dot-skill" width="240">
>
> QR обновляется каждые 7 дней (истекает 2026-04-24) — если истёк, пиши мне в Discord.

> 🆕 **Обновление 2026.04.13** — **Дорожная карта dot-skill опубликована!** colleague.skill эволюционирует в **dot-skill** — дистиллируй кого угодно, не только коллег.
>
> 👉 **[Читать полную дорожную карту](../../ROADMAP.md)** · **[💬 Discord](https://discord.gg/aRjmJBdK)**

> 🆕 **Обновление 2026.04.07** — Галерея сообщества запущена! Любой skill или meta-skill может направлять трафик прямо в твой GitHub-репозиторий. Без посредников.
>
...
<details>
<summary>Хочешь установить вручную? Жми — тут пути</summary>
...
Сначала он спросит, какое семейство ты хочешь дистиллировать: `colleague`, `relationship` или `celebrity`.
...
- **Качество исходников = качество Skill'а** — и что считается качественным источником, у семейств разное:
  - **colleague**: **их собственные длинные тексты** (дизайн-доки / ревью-комменты) > **ответы с принятием решений** > повседневный групповой чат; автосбор Feishu требует, чтобы App-бот был добавлен в нужные групповые чаты
  - **relationship**: полная история переписки > письма / посты в соцсетях / дневники > описания третьих лиц; чем длиннее временной охват — тем лучше, идеально — материалы, покрывающие и конфликт, и восстановление
  - **celebrity**: книги / блоги / длинные интервью от первого лица > записи решений (запуски, коммиты, Q&A) > сторонние комментарии; не корми только пересказами из вторых рук
